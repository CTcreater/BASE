...
class Calendar:
    ...
    def __place_widgets(self):
        ...
        tkinter.ttk.Button(self.bframe, text = '确定', width = 6, command = lambda: self._exit(True)).grid(row = 0, column = 0, sticky = 'ns', padx = 20)
        tkinter.ttk.Button(self.bframe, text = '取消', width = 6, command = self._exit).grid(row = 0, column = 1, sticky = 'ne', padx = 20)
